...
create table `report_top_hits_density` (`radius_ind` int(2) unsigned not null, `fold_ind` int(2) unsigned not null, `v_ind` int(8) unsigned not null, `r_density` int(4) unsigned not null, `density` double not null, `left_ind` int(8) unsigned not null, `right_ind` int(8) unsigned not null, `left_count` int(4) unsigned not null, `right_count` int(4) unsigned not null, `naive_p` double, `adj_p` double, primary key(`radius_ind`,`fold_ind`,`v_ind`), key(`r_density`));
create table `report_top_hits_pval` (`radius_ind` int(2) unsigned not null, `fold_ind` int(2) unsigned not null, `v_ind` int(8) unsigned not null, `r_density` int(4) unsigned not null, `density` double not null, `left_ind` int(8) unsigned not null, `right_ind` int(8) unsigned not null, `left_count` int(4) unsigned not null, `right_count` int(4) unsigned not null, primary key(`radius_ind`, `fold_ind`,`v_ind`), key(`r_density`));
